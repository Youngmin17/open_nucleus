...
module sram_64x6144_wrapper (
    ...
    generate
        for (i = 0; i < 32; i = i + 1) begin: SRAM_ARRAY_64x160
    ...
    generate
        for (i = 0; i < 8; i = i + 1) begin: SRAM_ARRAY_64x128
            sram_64x128 u_sram_64x128 (
                .rdata   (rdata[5120+128*i +: 128]),
                .clk     (clk),
                .re_n    (~read_enable),
                .we_n    (~write_enable),
                .raddr   (raddr),
                .waddr   (waddr),
                .wdata   (wdata[5120+128*i +: 128])
            );
        end
    endgenerate
